...
```bash
php artisan vendor:publish --tag="filament-barcode-scanner-field-migrations"
php artisan migrate
```
...
```php
$filamentBarcodeScannerField = new Marcelorodrigo\FilamentBarcodeScannerField();
echo $filamentBarcodeScannerField->echoPhrase('Hello, Marcelorodrigo!');
```
